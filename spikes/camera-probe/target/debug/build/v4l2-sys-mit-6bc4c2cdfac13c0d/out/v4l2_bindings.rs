...
pub const V4L2_CID_FLASH_DURATION: u32 = 10225933;
pub const V4L2_CID_FLASH_STROBE_OE: u32 = 10225934;
...
pub const V4L2_CID_STATELESS_HEVC_EXT_SPS_ST_RPS: u32 = 10750616;
pub const V4L2_CID_STATELESS_HEVC_EXT_SPS_LT_RPS: u32 = 10750617;
...
pub const V4L2_HEVC_EXT_SPS_ST_RPS_FLAG_INTER_REF_PIC_SET_PRED: u32 = 1;
pub const V4L2_HEVC_EXT_SPS_LT_RPS_FLAG_USED_LT: u32 = 1;
...
pub struct v4l2_ctrl_hevc_ext_sps_st_rps {
    ...
    pub delta_poc_s0_minus1: [__u16; 16usize],
    pub delta_poc_s1_minus1: [__u16; 16usize],
    pub flags: __u16,
}
#[test]
fn bindgen_test_layout_v4l2_ctrl_hevc_ext_sps_st_rps() {
    const UNINIT: ::std::mem::MaybeUninit<v4l2_ctrl_hevc_ext_sps_st_rps> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<v4l2_ctrl_hevc_ext_sps_st_rps>(),
        80usize,
        concat!("Size of: ", stringify!(v4l2_ctrl_hevc_ext_sps_st_rps))
    );
    assert_eq!(
        ::std::mem::align_of::<v4l2_ctrl_hevc_ext_sps_st_rps>(),
        4usize,
        concat!("Alignment of ", stringify!(v4l2_ctrl_hevc_ext_sps_st_rps))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ctrl_hevc_ext_sps_st_rps),
            "::",
            stringify!(delta_idx_minus1)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).delta_rps_sign) as usize - ptr as usize },
        1usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ctrl_hevc_ext_sps_st_rps),
            "::",
            stringify!(delta_rps_sign)
        )
    );
    assert_eq!(
    ...
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).used_by_curr_pic) as usize - ptr as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ctrl_hevc_ext_sps_st_rps),
            "::",
            stringify!(used_by_curr_pic)
        )
    );
    assert_eq!(
...
#[test]
fn bindgen_test_layout_v4l2_ctrl_hevc_ext_sps_lt_rps() {
    const UNINIT: ::std::mem::MaybeUninit<v4l2_ctrl_hevc_ext_sps_lt_rps> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<v4l2_ctrl_hevc_ext_sps_lt_rps>(),
        4usize,
        concat!("Size of: ", stringify!(v4l2_ctrl_hevc_ext_sps_lt_rps))
    );
    assert_eq!(
        ::std::mem::align_of::<v4l2_ctrl_hevc_ext_sps_lt_rps>(),
        2usize,
        concat!("Alignment of ", stringify!(v4l2_ctrl_hevc_ext_sps_lt_rps))
    );
    assert_eq!(
        ...
        concat!(
            "Offset of field: ",
            stringify!(v4l2_ctrl_hevc_ext_sps_lt_rps),
            "::",
...
pub const v4l2_ctrl_type_V4L2_CTRL_TYPE_HEVC_EXT_SPS_ST_RPS: v4l2_ctrl_type = 629;
pub const v4l2_ctrl_type_V4L2_CTRL_TYPE_HEVC_EXT_SPS_LT_RPS: v4l2_ctrl_type = 630;
