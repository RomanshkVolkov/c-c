...
import { Plus, KeyRound, Trash2, Pencil, RefreshCw } from "lucide-react";
  ...
  return (
    <div className="space-y-1">
      ...
      <p className="text-xs text-muted-foreground">
        ...
        <code className="text-xs">X-Cac-Signature</code>. Verify it over the raw body.
      </p>
    </div>
  );
}
    ...
    <div className="flex items-center gap-2 rounded-md border p-2.5 text-sm">
      <div className="flex-1 min-w-0">
        <div className="flex items-center gap-2">
          ...
          {!p.isActive && <Badge variant="destructive" className="text-xs py-0">inactive</Badge>}
        </div>
