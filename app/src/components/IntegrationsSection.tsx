...
function IntegrationTile({
  ...
  return (
    <div className="rounded-lg border p-3 text-sm">
      ...
      <p className="mt-1 truncate font-mono text-[11px] text-muted-foreground">{it.url}</p>
        ...
        <div className="mt-2">
          {revealed == null ? (
            ...
            <div className="flex items-center gap-1.5">
              <pre className="flex-1 overflow-auto rounded bg-muted/50 px-2 py-1 text-[11px] whitespace-pre-wrap break-all">
                {revealed || "(empty)"}
              </pre>
